...
<img px-3 py-2 rounded-md ring-8 ring-offset-4 bg-slate-200 ring-slate-300 dark:bg-slate-800 dark:ring-slate-900 dark:ring-offset-0 src="/images/sapogin.jpg">
...
<img h-9 src= "/images/equation1.svg"/>

В случае плоской симметрии уравнение имеет вид (2):

<img h-12 src= "/images/equation2.svg"/>
...
<img h-15 src= "/images/equation3.svg"/>

Вводя обобщённую потенциальную функцию (3):

<img h-15 src= "/images/equation4.svg"/>

Приходим к интегралу «живых сил» (по терминологии Э. Камке) (4)

<img h-15 src= "/images/equation5.svg"/>
